function Business(id, name, regionId, syncDate, description, phone, add1, add2, opHours, holidayOpHours, bizImg, logoImg) {
    this.id = id;
    this.name = name;
...
Business.prototype.toString = function() {
    return "(" + this.id + ", " + this.name + ", " + this.regionId + ", " + this.syncDate + ", " + this.description + ", " + this.phone + ", " + this.add1 + ", " + this.add2 + ", " + this.opHours + ", " + this.holidayOpHours + ", " + this.bizImg + ", " + this.logoImg + ")";
};
